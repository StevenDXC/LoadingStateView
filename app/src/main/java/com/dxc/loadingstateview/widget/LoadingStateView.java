package com.dxc.loadingstateview.widget;
...
import com.dxc.loadingstateview.R;
...
public class LoadingStateView extends View {
    ...
    private void setupAttr(Context context, AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LoadingStateView, 0, 0);
        int size = ta.getInt(R.styleable.LoadingStateView_view_size,1);
        if(size == 1){
        ...
        mColorNormal = ta.getColor(R.styleable.LoadingStateView_color_normal,0xff666666);
        mColorSuccess = ta.getColor(R.styleable.LoadingStateView_color_success,Color.GREEN);
        mColorFailed = ta.getColor(R.styleable.LoadingStateView_color_failed,Color.RED);
        mColorEmptyResult = ta.getColor(R.styleable.LoadingStateView_color_empty,0xfffdd835);
        ta.recycle();
    }
    ...
    private void playShakeAnimation(){
        ObjectAnimator animator = ObjectAnimator.ofFloat(this,"rotation",0.0f,20.0f);
